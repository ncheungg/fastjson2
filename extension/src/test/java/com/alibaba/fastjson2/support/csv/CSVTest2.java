...
// CSVParser.Feature.IgnoreEmptyLine));
// }
...
// for (String string : strings) {
// assertEquals(1, CSVParser.rowCount(string.getBytes(),
// CSVParser.Feature.IgnoreEmptyLine));
// }
// }
...
// for (String string : strings) {
// assertEquals(2,
// CSVParser.rowCount(string.getBytes(StandardCharsets.UTF_8),
// CSVParser.Feature.IgnoreEmptyLine));
// }
// }
...
// URL resource =
// this.getClass().getClassLoader().getResource("organised_Gen.csv.zip");
// if (resource == null) {
// return;
// }
...
// URL resource =
// this.getClass().getClassLoader().getResource("organised_Gen.csv");
// if (resource == null) {
// return;
// }
